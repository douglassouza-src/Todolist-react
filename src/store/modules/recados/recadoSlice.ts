...
import { apiDelete, apiGet, apiPost, apiPut } from '../../../shared/environment/index';
...
export const { selectAll: buscarRecados, selectById: buscarRecadosId } = adapter.getSelectors((state: RootState) => state.recados);
...
const recadosSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(getRecadosUser.pending, (state) => { state.loading = true });
    ...
    builder.addCase(getRecadosUserbyKey.pending, (state) => { state.loading = true });
    ...
    builder.addCase(getRecadosArquivados.pending, (state) => { state.loading = true });
  ...
  //Recados post
  builder.addCase(newRecado.pending, (state) => { state.loading = true });
  ...
  //Recado delete
  builder.addCase(deleteRecado.pending, (state) => { state.loading = true });
  ...
  //Recado Update
  builder.addCase(updateRecado.pending, (state) => { state.loading = true });
