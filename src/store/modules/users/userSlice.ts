...
export const { selectAll: buscarUsuarios, selectById: buscarUsuarioID } =
  usersAdapter.getSelectors<RootState>((state) => state.users);

export const getUsers = createAsyncThunk<ResponseAPI>(
  "users/getUsers",
  async () => {
...
export const saveNewUser = createAsyncThunk<ResponseAPI, newUserRequest>(
  "users/saveNewUser",
  async (newUserData: newUserRequest) => {
